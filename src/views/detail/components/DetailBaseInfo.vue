<!--
 * @Author: your name
 * @Date: 2020-03-18 14:21:46
 * @LastEditTime: 2020-03-31 16:51:42
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \project\supermall\src\views\detail\components\DetailBaseInfo.vue
 -->
<template>
  <!-- 使用v-if判断该对象是否有内容、没内容就不进行之后的渲染操作 -->
  <div class="base-info" v-if="Object.keys(baseInfo).length !== 0">
    ...
    <div class="info-service">
      <span
        ...
        :key="index"
      >
        <img :src="'http:' + baseInfo.services[index - 1].icon" />
